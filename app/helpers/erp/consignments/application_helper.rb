    ...
    module ApplicationHelper
      ...
      def consignment_dropdown_actions(consignment)
        ...
        actions << {
          ...
          target: '_blank'
        } if can? :excel_export, consignment
        ...
        actions << {
          ...
          url: erp_consignments.set_draft_backend_consignments_path(id: consignment),
          data_method: 'PUT',
          class: 'ajax-link'
        ...
        actions << {
          ...
          url: erp_consignments.set_active_backend_consignments_path(id: consignment),
          data_method: 'PUT',
          class: 'ajax-link'
        ...
        actions << {
          ...
          url: erp_consignments.set_delivered_backend_consignments_path(id: consignment),
          data_method: 'PUT',
          class: 'ajax-link'
        ...
        if can? :set_deleted, consignment
          if (can? :print, consignment) or (can? :excel_export, consignment) or (can? :update, consignment) or
             (can? :set_draft, consignment) or (can? :set_active, consignment) or (can? :set_delivered, consignment) or
             (can? :create_consignment_return, consignment)
        ...
        actions << {
          ...
          url: erp_consignments.set_deleted_backend_consignments_path(id: consignment),
          data_method: 'PUT',
          class: 'ajax-link',
      ...
      def cs_return_dropdown_actions(cs_return)
        ...
        actions << {
          ...
          url: erp_consignments.set_draft_backend_cs_returns_path(id: cs_return),
          data_method: 'PUT',
          class: 'ajax-link'
        ...
        actions << {
          ...
          url: erp_consignments.set_active_backend_cs_returns_path(id: cs_return),
          data_method: 'PUT',
          class: 'ajax-link'
        ...
        actions << {
          ...
          url: erp_consignments.set_delivered_backend_cs_returns_path(id: cs_return),
          data_method: 'PUT',
          class: 'ajax-link'
        ...
        actions << {
          ...
          url: erp_consignments.set_deleted_backend_cs_returns_path(id: cs_return),
          data_method: 'PUT',
          class: 'ajax-link',
